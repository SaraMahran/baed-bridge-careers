...
// // import bumbleTectLogo from "@/assets/Testimonials/bumbleb.tech.jpeg";
...
// //   "Brand 06", "Brand 07", "Brand 08", "Brand 09", "Brand 10",
// //   "Brand 11", "Brand 12",
// // ];
...
// //               <img src={teamPhoto} alt="Reem Ali Mahran and Atef Gwily" className="w-full h-72 md:h-96 object-cover object-top" />
...
// //                 <div className="w-12 h-12 rounded-full bg-[#a0205b] flex items-center justify-center text-[#fff279] font-black text-lg">RM</div>
// //                 <div>
...
// //               <div className="flex items-center gap-3 mb-4">
// //                 <div className="w-12 h-12 rounded-full bg-[#5f1a37] flex items-center justify-center text-[#fff279] font-black text-lg">AG</div>
// //                 <div>
...
// //               <div key={i} className="inline-flex items-center justify-center px-6 py-3 rounded-2xl bg-[#f9f2c2] border border-[#a0205b]/20 text-[#5f1a37] font-semibold text-sm shrink-0 min-w-[140px]">
// //                 {logo}
// //               </div>
// //             ))}
// //           </div>
...
// //           </motion.div>
// //           <div className="relative">
// //                         <motion.div key={activeTestimonial} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}
// //               className="rounded-3xl bg-gradient-to-br from-[#5f1a37] via-[#a0205b] to-[#c374ae] p-10 text-center mb-6 relative overflow-hidden">
...
// //                 <Star className="h-6 w-6 text-[#fff279] mx-auto mb-4" />
// //                 <p className="text-[#f9f2c2] text-lg leading-relaxed mb-6 max-w-2xl mx-auto">
// //                   "{testimonials[activeTestimonial].quote}"
// //                 </p>
// //                 <div className="flex items-center justify-center gap-4">
// //                 <span className="text-lg">{testimonials[activeTestimonial].flag}</span>
...
// //                   className={`w-2.5 h-2.5 rounded-full transition-all duration-200 ${i === activeTestimonial ? "bg-[#a0205b] w-6" : "bg-[#a0205b]/30"}`}
// //                 />
// //               ))}
// //             </div>
// //           </div>
...
//             <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-60px" }} variants={fadeUp} custom={0}
//               className="rounded-3xl overflow-hidden bg-[#5f1a37]">
//               <img src={teamPhoto} alt="Reem Ali Mahran and Atef Gwily" className="w-full h-72 md:h-80 object-cover object-top" />
//               <div className="grid md:grid-cols-2 gap-0">
//                 <div className="p-8 border-r border-[#a0205b]/30">
//                   <p className="text-[#daa9cd] text-xs font-semibold uppercase tracking-wider mb-1">CEO & Co-founder</p>
//                   <p className="font-bold text-[#fff279] text-lg mb-3">Reem Ali Mahran</p>
...
//               <div className="relative z-10">
//                 <Star className="h-6 w-6 text-[#fff279] mx-auto mb-4" />
//                 <p className="text-[#f9f2c2] text-lg leading-relaxed mb-8 max-w-2xl mx-auto">
//                   "{testimonials[activeTestimonial].quote}"
//                 </p>
//                 {/* Author row: flag + name/country + circular logo */}
//                 <div className="flex items-center justify-center gap-4">
...
//                   </div>
//                   {testimonials[activeTestimonial].logo && (
//                     <div className="w-10 h-10 rounded-full bg-white border-2 border-[#fff279]/40 overflow-hidden flex items-center justify-center shrink-0 shadow-md">
//                       <img
//                         src={testimonials[activeTestimonial].logo}
//                         alt={testimonials[activeTestimonial].author}
//                         className="w-full h-full object-cover"
