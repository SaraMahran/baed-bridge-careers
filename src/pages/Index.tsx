...
//   return (
//     <section className="py-4 relative overflow-hidden bg-[#5f1a37] border-b border-[#a0205b]/30">
//       <motion.div
//         className="absolute inset-0 bg-gradient-to-r from-transparent via-[#fff279]/3 to-transparent pointer-events-none"
//         animate={{ x: ["-100%", "100%"] }}
//         transition={{ duration: 4, repeat: Infinity, ease: "linear", repeatDelay: 3 }}
//       />
//       <div className="container relative z-10">
//         <div className="flex items-center justify-center gap-3">
//           <div className="w-1.5 h-1.5 rounded-full bg-[#fff279] shrink-0" />
//           <p className="text-[#f9f2c2] text-sm">
//             Recognized among{" "}
//             <span className="text-[#fff279] font-bold">Top 100 Startups in Egypt</span>
//             <span className="text-[#daa9cd] mx-2">·</span>
//             <span className="text-[#daa9cd]">TotalEnergies Startupper of the Year 2024</span>
//           </p>
//           <div className="w-1.5 h-1.5 rounded-full bg-[#fff279] shrink-0" />
//         </div>
//       </div>
...
// function AwardBannerSection() {
//   return (
//     <section className="py-5 relative overflow-hidden bg-[#5f1a37] border-y border-[#a0205b]/30">
//       {/* Shimmer sweep */}
//       <motion.div
...
//           {/* Left tag */}
//           <span className="bg-[#fff279]/10 border border-[#fff279]/25 text-[#fff279] text-[10px] font-bold uppercase tracking-widest px-3 py-1 rounded-full shrink-0">
//             TotalEnergies Startupper 2024
//           </span>

//           {/* Dot separator */}
//           <div className="hidden sm:block w-1 h-1 rounded-full bg-[#a0205b] shrink-0" />

//           {/* Main text */}
//           <p className="text-[#f9f2c2] text-sm leading-relaxed">
//             <span className="text-[#fff279] font-bold">Top 100 Shortlisted Startup in Egypt</span>
//             <span className="text-[#daa9cd] mx-2">—</span>
//             <span className="text-[#f9f2c2]/70">Recognized for innovation in sustainable development & digital inclusion</span>
//           </p>
...
//           {/* Right tag */}
//           <span className="bg-[#a0205b]/30 border border-[#a0205b]/40 text-[#daa9cd] text-[10px] font-semibold uppercase tracking-widest px-3 py-1 rounded-full shrink-0">
//             National Selection & Public Vote
//           </span>
//         </div>
//       </div>
//     </section>
