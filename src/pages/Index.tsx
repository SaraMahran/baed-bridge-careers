...
// // //                 className="p-5 rounded-2xl bg-[#a0205b] border border-[#a0205b]"
// // //               >
...
// // //     {
// // //       number: "1",
// // //       title: "Strongest Selling Point",
// // //       desc: "A precise statement framing your lived experience as a professional asset.",
// // //     },
// // //     {
// // //       number: "2",
// // //       title: "Best Job Match",
// // //       desc: "Direct alignment between your background, skills, and accessibility needs.",
// // //     },
// // //     {
// // //       number: "3",
// // //       title: "Recommended Courses",
// // //       desc: "Targeted learning paths to bridge skill gaps and ensure market readiness.",
// // //     },
// // //     {
// // //       number: "4",
// // //       title: "Custom Resume Tips",
// // //       desc: "Bespoke guidance on presenting your profile for the content marketing industry.",
// // //     },
// // //   ];
...
// // //               <motion.div className="w-full h-full bg-white/5" animate={{ scale: [1.15, 1, 1.15] }} transition={{ duration: 6, repeat: Infinity, ease: "easeInOut", delay: 1 }} />
// // //             </div>
...
// // //                   Tell Gemini AI about your background and accessibility needs. It instantly designs your personalized journey: from recommending the right courses to bridge your skills, to strategic resume tips and interview prep, guiding you to your perfect career match.
// // //                 </p>
...
// // //                     </Link>
// // //                   </Button>
// // //                   <Button size="lg" variant="outline" className="border-white/40 text-white bg-transparent hover:bg-[#fff279] hover:text-[#5f1a37] hover:border-[#fff279]" asChild>
// // //                     <Link to="/courses">Browse Courses</Link>
// // //                   </Button>
// // //                 </div>
// // //               </motion.div>

// // //               {/* Right — numbered result cards */}
...
// // //                   >
// // //                     <span className="flex items-center justify-center w-8 h-8 rounded-full bg-[#fff279] text-[#5f1a37] text-sm font-black shrink-0">
// // //                       {item.number}
// // //                     </span>
// // //                     <div>
...
// //                 <div className="inline-flex items-center gap-2 bg-white/15 text-[#f9f2c2] px-4 py-2 rounded-full text-xs font-semibold mb-6 border border-white/20">
// //                   <Sparkles className="h-3.5 w-3.5" />
// //                   Powered by Gemini AI
// //                 </div>
// //                 <h2 className="text-3xl md:text-4xl font-extrabold text-[#f9f2c2] leading-tight mb-6">
// //                   Your career roadmap,{" "}
// //                   <span className="text-[#fff279]">in 30 seconds.</span>
// //                 </h2>
// //                 <p className="text-[#f9f2c2]/75 text-base leading-relaxed mb-8">
// //                   Tell Gemini AI about your background and accessibility needs. It instantly designs your personalized journey: from recommending the right courses to bridge your skills, to strategic resume tips and interview prep, guiding you to your perfect career match.
// //                 </p>
// //                 <div className="flex flex-col sm:flex-row gap-3">
// //                   <Button size="lg" className="bg-[#fff279] text-[#5f1a37] hover:bg-[#fff060] font-bold shadow-lg" asChild>
...
// //                     initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-60px" }}
// //                     variants={slideRight} custom={i}
// //                     className="flex items-start gap-4 bg-[#f9f2c2]/10 backdrop-blur-sm rounded-xl p-4 border border-[#f9f2c2]/10"
// //                   >
// //                     <span className="flex items-center justify-center w-8 h-8 rounded-full bg-[#a0205b] text-[#f9f2c2] text-sm font-black shrink-0">
// //                       {item.number}
// //                     </span>
// //                     <div>
...
// //               <Link
// //                 to={a.href}
// //                 className="block p-8 rounded-2xl bg-[#f9f2c2] border border-border hover:border-primary/30 hover:shadow-lg transition-all duration-300 group h-full"
// //               >
// //                 <div className={`inline-flex p-3 rounded-xl ${a.color} mb-5`}>
// //                   <a.icon className="h-6 w-6" />
// //                 </div>
...
// //         <div className="grid lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
// //           <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-80px" }} variants={slideLeft} custom={0}>
// //             <h2 id="learner-features-heading" className="text-3xl md:text-4xl font-bold">What Learners Get</h2>
// //             <p className="mt-4 text-muted-foreground text-lg leading-relaxed">
// //               Everything you need to build a successful career in content marketing — from structured learning to hands-on mentorship and real job placement support.
// //             </p>
// //           </motion.div>
// //           <div className="grid sm:grid-cols-2 gap-4">
// //             {features.map((f, i) => (
...
// //                 initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-60px" }}
// //                 variants={scaleIn} custom={i}
// //                 className="flex items-start gap-3 p-4 rounded-xl bg-[#f9f2c2] border border-border hover:border-primary/30 hover:shadow-sm transition-all duration-200"
// //               >
// //                 <f.icon className="h-5 w-5 text-primary mt-0.5 shrink-0" />
// //                 <span className="text-sm font-medium">{f.label}</span>
// //               </motion.div>
...
// //             <p className="mt-4 text-muted-foreground text-lg leading-relaxed">
// //               Build a more inclusive workplace with access to skilled talent, expert resources, and guidance on creating accessible content and work environments.
// //             </p>
// //           </motion.div>
// //         </div>
// //       </div>
...
// //             <p className="mt-4 text-lg text-[#f9f2c2]/70 leading-relaxed">
// //               Whether you're ready to learn new skills or build an inclusive team, Baed Connect is here for you.
// //             </p>
// //             <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
// //               <Button size="lg" className="bg-[#fff279] text-[#5f1a37] hover:bg-[#fff060] font-bold shadow-lg" asChild>
...
// //               <Link
// //                 to="/get-started"
// //                 className="inline-flex items-center justify-center gap-2 h-11 px-8 text-base font-bold rounded-md border-2 border-[#f9f2c2]/40 text-[#f9f2c2] bg-transparent hover:bg-[#fff279] hover:text-[#5f1a37] hover:border-[#fff279] transition-all duration-200"
// //               >
// //                 <GraduationCap className="h-5 w-5" />
// //                 Get Started Free
// //               </Link>
...
// //       desc: "Naturally supports remote work and flexible hours — build a career that fits your accessibility needs, not the other way around.",
// //       icon: <Home className="h-4 w-4" />,
// //     },
// //     {
// //       title: "AI-driven accessibility",
// //       desc: "From screen reader support to automated formatting, AI removes technical friction — making creation seamless and inclusive by design.",
// //       icon: <Sparkles className="h-4 w-4" />,
// //     },
// //     {
// //       title: "Low-stimulation professionalism",
// //       desc: "Work independently in environments that suit your sensory needs — focusing on high-impact results rather than office constraints.",
// //       icon: <Heart className="h-4 w-4" />,
// //     },
// //     {
// //       title: "A scalable foundation",
// //       desc: "Mastering content is the launchpad — providing the digital mindset and tech-literacy to grow into any tech-driven industry.",
...
// //                 initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-60px" }}
// //                 variants={scaleIn} custom={i}
// //                 className="bg-[#f9f2c2]/5 border border-[#f9f2c2]/15 rounded-2xl p-6"
// //               >
// //                 <div className="w-9 h-9 rounded-xl bg-[#a0205b]/50 flex items-center justify-center text-[#fff279] mb-4">
// //                   {f.icon}
// //                 </div>
      ...
      <div className="container max-w-6xl mx-auto">
        ...
        {/* <div className="grid md:grid-cols-2 gap-6 mb-12">
          <motion.div
            ...
            className="rounded-2xl bg-[#f9f2c2] p-8 border-[#a0205b]/20"
          >
            ...
            <Link to="/learners" className="inline-flex items-center gap-1.5 mt-5 text-sm font-semibold text-[#5f1a37] hover:text-[#fff060] transition-colors">
          ...
          <motion.div
            ...
            className="rounded-2xl bg-[#5f1a37]/5 border border-[#a0205b]/20 p-8"
          >
      ...
      <div className="container">
        <div className="grid lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-80px" }} variants={slideLeft} custom={0}>
            ...
            <p className="mt-4 text-muted-foreground text-lg leading-relaxed">
              One AI-powered platform designed to bypass accessibility barriers and accelerate your career.
            </p>
          </motion.div>
          <div className="grid sm:grid-cols-2 gap-4">
            {features.map((f, i) => (
      ...
      <div className="container">
        <div className="grid lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
          ...
          <motion.div className="order-1 lg:order-2" initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-80px" }} variants={slideRight} custom={0}>
            <h2 id="employer-features-heading" className="text-3xl md:text-4xl font-bold">What Employers Get</h2>
            <p className="mt-4 text-muted-foreground text-lg leading-relaxed">
              Empowering your workplace with market-ready talent and tools for digital inclusion.
            </p>
          </motion.div>
        </div>
      </div>
...
function HowItWorksSection() {
  const talentSteps = [
    { label: "Join", desc: "Create your profile." },
    { label: "Path", desc: "Get your AI roadmap." },
    { label: "Learn", desc: "Complete accessible courses." },
    { label: "Grow", desc: "Get expert mentorship." },
    { label: "Apply", desc: "Match with top roles." },
  ];
  const employerSteps = [
    { label: "Register", desc: "Create your account." },
    { label: "Learn", desc: "Explore inclusion guides." },
    { label: "Discover", desc: "Find trained talents." },
    { label: "Post", desc: "Share job opportunities." },
    { label: "Hire", desc: "Build inclusive teams." },
  ];
                ...
                {track.steps.map((step, i) => (
                  <motion.li key={i} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={i * 0.5} className="flex items-start gap-3">
                    ...
                    <span className="text-sm text-muted-foreground">
                      <span className="font-semibold text-foreground">{step.label}:</span> {step.desc}
                    </span>
                  </motion.li>
                ))}
              </ol>
...
//   return (
//     <section className="py-20 bg-[#fff9c6]" aria-labelledby="about-heading">
//       <div className="container max-w-6xl mx-auto">
//         <motion.div
//           initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-80px" }}
//           variants={fadeUp} custom={0}
...
//   return (
//     <section className="py-20 bg-[#fff9c6]" aria-labelledby="learner-features-heading">
//       <div className="container">
//         <div className="grid lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
//           <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-80px" }} variants={slideLeft} custom={0}>
//             <h2 id="learner-features-heading" className="text-3xl md:text-4xl font-bold">What Talents Get</h2>
...
//                 initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-60px" }}
//                 variants={scaleIn} custom={i}
//                 className="flex items-start gap-3 p-4 rounded-xl bg-[#f9f2c2] border border-[#a0205b]/20 hover:border-primary/30 hover:shadow-sm transition-all duration-200"
//               >
//                 <f.icon className="h-5 w-5 text-primary mt-0.5 shrink-0" />
//                 <span className="text-sm font-medium">{f.label}</span>
//               </motion.div>
...
//   return (
//     <section className="py-20 bg-[#fff9c6]" aria-labelledby="how-it-works-heading">
//       <div className="container">
//         <motion.h2
//           id="how-it-works-heading"
//           className="text-3xl md:text-4xl font-bold text-center mb-14"
...
//               initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-80px" }}
//               variants={idx === 0 ? slideLeft : slideRight} custom={1}
//               className="p-8 rounded-2xl border border-[#a0205b]/20 bg-[#f9f2c2]"
//             >
//               <div className="flex items-center gap-3 mb-6">
//                 <div className="p-2.5 rounded-xl bg-primary/10">
//                   <track.icon className="h-5 w-5 text-primary" />
...
// function MissionSection() {
//   return (
//     <section className="py-20 bg-[#fff9c6]" aria-labelledby="mission-heading">
//       <div className="container">
//         <div className="max-w-3xl mx-auto text-center">
//           <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-80px" }} variants={fadeUp} custom={0}>
//             <motion.div animate={{ scale: [1, 1.1, 1] }} transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}>
...
// function PartnershipSection() {
//   return (
//     <section className="py-20 bg-[#fff9c6]" aria-labelledby="partner-heading">
//       <div className="container">
//         <div className="max-w-3xl mx-auto text-center">
//           <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-80px" }} variants={fadeUp} custom={0}>
//             <Handshake className="h-10 w-10 text-primary mx-auto mb-6" />
